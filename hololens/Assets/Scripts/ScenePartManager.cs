...
public class ScenePartManager : MonoBehaviour
{
    ...
    private void ProcessUserCommand(string command)
    {
        ...
        //else if (args[0] == "file")
        //{
        //    string path = "Assets/Files/" + args[1] + ".txt";
        ...
        //                AddGameObjectInScenePart(objectName, position, rotation);//, targetScene.name, virtualScene.name, remoteSceneName, position, rotation);
        //            }
        ...
        //                float scale = float.Parse(param[5]);

        //                //AddGameObjectInScenePart(line, targetScene.name, virtualScene.name, remoteSceneName);
        //                AddGameObjectInScenePart(objectName, position, rotation, scale);//, targetScene.name, virtualScene.name, remoteSceneName, position, rotation, scale);
        //            }
