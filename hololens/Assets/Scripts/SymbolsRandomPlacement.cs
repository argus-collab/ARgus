...
public class SymbolsRandomPlacement : MonoBehaviour
{
    ...
    private List<Sprite> randomizedSymbolsFaceA;
    private List<Sprite> randomizedSymbolsFaceB;
    private List<SpriteRenderer> randomizedWallA1;
    private List<SpriteRenderer> randomizedWallA2;
    private List<SpriteRenderer> randomizedWallA3;
    private List<SpriteRenderer> randomizedWallB1;
    private List<SpriteRenderer> randomizedWallB2;
    private List<SpriteRenderer> randomizedWallB3;
    private int symbolIndexA;
    private int symbolIndexB;
