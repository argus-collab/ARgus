...
public class HandConsistancyRecreator : MonoBehaviour
{
    ...
    public void CreateHandConsistency(string laterality)
    {
        CreatePalmConsistency(laterality);
    ...
    public void CreatePhalange(string name, GameObject top, GameObject bottom, string laterality)
    {
    ...
    public void CreatePalmPart(GameObject top, GameObject bottom, string laterality)
    {
    ...
    public void CreatePalmConsistency(string laterality)
    {
        if(laterality == "right")
        {
            CreatePalmPart(right_thumb_proximal, right_thumb_metacarpal, laterality);
        ...
        {
            CreatePalmPart(left_thumb_proximal, left_thumb_metacarpal, laterality);
    ...
    public void CreateThumbConsistency(string laterality)
    {
        if (laterality == "right")
        {
            CreatePhalange("distal_phalange", right_thumb_tip, right_thumb_distal, laterality);
            CreatePhalange("proximal_phalange", right_thumb_distal, right_thumb_proximal, laterality);
        }
        else
        {
            CreatePhalange("distal_phalange", left_thumb_tip, left_thumb_distal, laterality);
            CreatePhalange("proximal_phalange", left_thumb_distal, left_thumb_proximal, laterality);
        }
    }

    public void CreateIndexConsistency(string laterality)
    {
        if (laterality == "right")
        {
            CreatePhalange("distal_phalange", right_index_tip, right_index_distal, laterality);
        ...
        {
            CreatePhalange("distal_phalange", left_index_tip, left_index_distal, laterality);
    ...
    public void CreateMiddleConsistency(string laterality)
    {
        if (laterality == "right")
        {
            CreatePhalange("distal_phalange", right_middle_tip, right_middle_distal, laterality);
        ...
        {
            CreatePhalange("distal_phalange", left_middle_tip, left_middle_distal, laterality);
    ...
    public void CreateRingConsistency(string laterality)
    {
        if (laterality == "right")
        {
            CreatePhalange("distal_phalange", right_ring_tip, right_ring_distal, laterality);
        ...
        {
            CreatePhalange("distal_phalange", left_ring_tip, left_ring_distal, laterality);
    ...
    public void CreatePinkyConsistency(string laterality)
    {
        if (laterality == "right")
        {
            CreatePhalange("distal_phalange", right_pinky_tip, right_pinky_distal, laterality);
        ...
        {
            CreatePhalange("distal_phalange", left_pinky_tip, left_pinky_distal, laterality);
