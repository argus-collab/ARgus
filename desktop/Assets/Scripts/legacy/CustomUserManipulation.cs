...
public class CustomUserManipulation : MonoBehaviour
{
    /*public RemoteSelectionUI selection;
                ...
                if (!isManipulating)
                {
                    ...
                    if(sketchGO != null)
                    {
                        ...
                        for (int i = 0; i < sketchGO.transform.childCount; ++i)
                        {
                            ...
                            //part.transform.localPosition = sketchGO.transform.GetChild(i).gameObject.transform.localPosition;
                            //part.transform.localRotation = sketchGO.transform.GetChild(i).gameObject.transform.localRotation;
