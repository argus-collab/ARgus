...
public class CameraPositionUIIndicator : MonoBehaviour
{
    ...
    void UpdateRepresentations()
    {
        ...
        for (int i = 0; i < representations.Count; ++i)
        {
            ...
            //representations[i].GetComponent<RectTransform>().anchorMin = Vector2.zero;
            //representations[i].GetComponent<RectTransform>().anchorMax = Vector2.zero;
            representations[i].GetComponent<RectTransform>().localRotation = Quaternion.identity;
            representations[i].GetComponent<RectTransform>().localScale = new Vector3(1,1,1);
            representations[i].GetComponent<RectTransform>().localPosition = new Vector3(x - widthDisplayArea / 2, y - heightDisplayArea / 2, 0.2f);
            //Debug.Log("x : " + x + ", y : " + y + "(widthScreen - widthDisplayArea) / 2 : " + (widthScreen - widthDisplayArea) / 2 + ", " + (heightScreen - heightDisplayArea) / 2);
            ...
            arrows[i].GetComponent<RectTransform>().localRotation = Quaternion.Euler(0, 0, Mathf.Rad2Deg * rot);
